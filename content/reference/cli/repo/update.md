...
<div class="highlight"><pre><code><b>~/github/octocat $</b> vela update repo --event tag</code></pre></div>

#### Targeted Request

<div class="highlight"><pre><code><b>~ $</b> vela update repo --org github --repo octocat --event tag</code></pre></div>
