...
Before contributing any code, make sure an issue](/docs/communityy/contributing_guidelines/#issues) exists, be sure to checkout current issues](https://github.com/go-vela/community/issues) and [proposals](https://github.com/go-vela/community/tree/master/proposals) to make sure your idea isn’t already being worked on. We're working on a public roadmap view to link here.

If there isn’t an issue, make sure to create one.

Vela is Target’s primary CI system. We will evaluate issues and proposals against our roadmap, what is best for Target, and makes sense to implement for other customers that will provide a general positive value.
...
See [style guide](/docs/communityy/contributing_guidelines/#style-guide) for guides on implementation.
...
Currently, main releases only apply to [core repos](/docs/communityy/contributing_guidelines/#core-repos). [Plugin repos](/docs/communityy/contributing_guidelines/#plugin-repos) get version cuts on an as needed basis.
