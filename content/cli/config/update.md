...
| ------------- | ------------------------------- | ---------------------------------------- |
| `addr`        | updates the API addr field      | `VELA_ADDR`, `CONFIG_ADDR`               |
| `token`       | updates the API token field     | `VELA_TOKEN`, `CONFIG_TOKEN`             |
...
| `engine`      | updates the secret engine field | `VELA_ENGINE`, `CONFIG_ENGINE`           |
| `type`        | updates the secret type field   | `VELA_TYPE`, `CONFIG_TYPE`               |
