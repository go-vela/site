...
The examples show a pipeline using repository secrets. Vela contains three secret types: repository, organization, and shared. Please see the [secret concepts](/docs/tour/secrets/) documentation.
